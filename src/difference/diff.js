...
// use a for loop where the 1st index in the array is iterated over the 0 index array elements and checked if each it is included or not. If included  remove it if not continue till the array length.
//
...
console.log(findDifference(array2D));
